...
export const strings = {
  fr: {
    ...
    analyticsClickHint: "Cliquez une ligne pour le profil complet.",
    ...
    colName: "Nom",
    colDate: "Date",
    colTopSpecialty: "Spécialité #1",
    colActions: "Actions",
    backToList: "Retour à la liste",
    backToWizard: "Retour orientation",
  ...
  en: {
    ...
    analyticsClickHint: "Click a row for the full profile.",
    applyFilters: "Apply",
    resetFilters: "Reset",
    filterFrom: "From",
    filterTo: "To",
