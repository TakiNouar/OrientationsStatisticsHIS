...
// NOTE: The remainder of this file (export CSV, analytics queries, getStudentProfile)
// is restored from the known-good commit body in a follow-up if truncated.
// Full analytics section must remain — see repo history if incomplete.
